...
@section('admin_content')
      <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="" action="{{URL::to('/add-brand-product')}}" method="post">
                      {{csrf_field()}}
                      <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Thêm thương hiệu</h5>
                                <?php
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" name="brandName" class="form-control" placeholder="Tên danh mục">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-description">Mô tả thương hiệu <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="product-description" name="brandDes" rows="5" placeholder="Please enter description"></textarea>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="radio form-check-inline">
                                        <input type="radio" id="inlineRadio1" value="1" name="brandStatus" checked="">
                                        <label for="inlineRadio1"> Hiện </label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" id="inlineRadio2" value="0" name="brandStatus">
