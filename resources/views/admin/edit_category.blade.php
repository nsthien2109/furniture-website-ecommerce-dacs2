                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" value="{{$value->CategoryName}}" name="cateName" class="form-control" placeholder="Tên danh mục">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-description">Mô tả danh mục <span class="text-danger">*</span></label>
                                    <textarea class="form-control" value="{{$value->CategoryDescrip}}" id="product-description" name="cateDes" rows="5" ></textarea>
                                </div>
                            </div> <!-- end card-box -->
                        </div> <!-- end col -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center mb-3">
                                ...
                                <button type="submit" name="add-category-product" class="btn w-sm btn-success waves-effect waves-light">Sửa</button>
                            </div>
                        </div> <!-- end col -->
                    </div>
                    </form>
