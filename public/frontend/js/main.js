(function ($) {
  ...
  $(".pro-qty").append('<a href="javascript:{}" onclick="document.getElementById("my_form").submit()" class="inc qty-btn">+</a>');
  $(".pro-qty").prepend('<a href="javascript:{}" onclick="document.getElementById("my_form").submit()" class="dec qty-btn">-</a>');
  ...
  $("#price-amount").val(
    "" +
      ...
      "VNĐ  - " +
      $("#price-range").slider("values", 1) + "VNĐ "
  );
